        ...
        <table className="w-full text-sm">
          <tbody className="divide-y divide-gray-200">
            <tr className="bg-gray-50">
              ...
              <td className="px-3 py-2 text-right font-medium text-slate-900">â¹{data.unit_price}</td>
            </tr>
            <tr>
              <td className="px-3 py-2 text-slate-600">Taxable Value</td>
              <td className="px-3 py-2 text-right font-medium text-slate-900">â¹{data.taxable_value}</td>
            </tr>
            <tr className="bg-gray-50">
              <td className="px-3 py-2 text-slate-600">CGST ({data.cgst_rate})</td>
              <td className="px-3 py-2 text-right font-medium text-slate-900">â¹{data.cgst_amount}</td>
            </tr>
            <tr>
              <td className="px-3 py-2 text-slate-600">SGST ({data.sgst_rate})</td>
              <td className="px-3 py-2 text-right font-medium text-slate-900">â¹{data.sgst_amount}</td>
            </tr>
            <tr className="border-t-2 border-gray-300 bg-slate-50">
              ...
              <td className="px-3 py-3 text-right text-lg font-semibold text-slate-900">â¹{data.total_amount}</td>
            </tr>
          </tbody>
        </table>
      </div>
